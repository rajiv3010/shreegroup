...
<body style="background-image: url('/images/mlmlogin.jpg'); " class="hold-transition login-page">
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Sign in to start your session</p>
     ...
     <form class="login-form" id="login-form" role="form" method="POST" action="/mlm/login">
                {{ csrf_field() }}
