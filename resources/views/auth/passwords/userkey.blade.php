...
@if(Session::has('message'))
            ...
            @endif
     <form class="login-form" id="login-form" role="form" method="POST" action="/sendPasswordResetLink">
                {{ csrf_field() }}
      <div class="form-group has-feedback">
        <input type="text" name="user_key" class="form-control" placeholder="Enter user id">
      ...
      <div class="row">
        ...
        <div class="col-xs-4 col-md-offset-4">
          <a  class="btn btn-primary btn-block btn-flat" href="/login">Login</a>
        </div>
        <!-- /.col -->
      </div>
    </form>
