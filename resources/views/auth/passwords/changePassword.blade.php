...
@endif
 @if(Session::has('message'))
    ...
    <p class="login-box-msg">Change Password</p>
     ...
     <form class="login-form" id="login-form" role="form" method="POST" action="/updatePassword">
                {{ csrf_field() }}
      <div class="form-group has-feedback">
       <input id="password" type="password" class="form-control" placeholder="New Password" name="password" required>
       <input id="hidden" type="hidden"  name="encodetoken" value="{{$encodetoken}}">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="password_confirmation" class="form-control" placeholder="confirmate Password">
        <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
