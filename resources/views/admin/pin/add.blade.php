 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    @endif   
          ...
          {!! Form::open(['url' => '/admin/pin/store','enctype'=>'multipart/form-data']) !!}
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                  <label>Qty</label>
                  <input type="number" name="qty" value="{{old('qty')}}" class="form-control" placeholder="Enter number of pin Generate">
                </div>
                </div>
